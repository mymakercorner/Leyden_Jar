...
#define LAYOUT_all( \
    ...
    k_lctrl,  k_a,    k_s,    k_d,    k_f, k_g, k_h, k_j, k_k, k_l,     k_semicolon, k_quote,   k_hashtag, k_return,           k_kp1, k_kp2, k_kp3,\
    k_lshift, k_nubs, k_z,    k_x,    k_c, k_v, k_b, k_n, k_m, k_comma, k_period,    k_slash,   k_rshift,  k_fn,               k_kp0, k_up,  k_kpdot,\
    k_caps,   k_lgui, k_lalt,         k_space,                          k_ralt,      k_numlock, k_rctrl,                       k_left,k_down,k_right\
) \
{ \
    { k_lctrl , k_lalt, k_v, k_space, k_m, k_comma    , KC_NO    , k_numlock, k_rctrl, k_down , KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, k_right},\
    { k_lgui  , k_z   , k_c, k_b    , k_n, k_period   , k_ralt   , k_rshift , k_left , k_kpdot, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO  },\
    { k_nubs  , k_x   , k_d, k_g    , k_k, k_l        , k_slash  , k_fn     , k_kp0  , k_up   , KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO  },\
    { k_lshift, k_s   , k_f, k_h    , k_j, k_semicolon, k_quote  , k_return , k_kp1  , k_kp3  , KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO  },\
    { k_caps  , k_a   , k_e, k_t    , k_u, k_o        , k_hashtag, k_bslash , k_kp2  , k_kp5  , KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO  },\
    { k_tab   , k_w   , k_r, k_y    , k_i, k_p        , k_lbrc   , k_rbrc   , k_kp4  , k_kp6  , KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO  },\
